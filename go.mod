...
require (
	...
	github.com/flare-foundation/go-flare-common v1.2.1-0.20260422200130-5b952b6a87ab
	github.com/flare-foundation/tee-node v0.0.20-0.20260422143628-1ac7226d9216
